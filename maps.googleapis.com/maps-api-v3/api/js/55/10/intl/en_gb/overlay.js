google.maps.__gjsload__("overlay", function (_) {
  var OD = function (a) {
    ...
    Ema = function (a, b) {
      ...
      e = () => _.Xm(d.Fh);
      c.Rh = [
        _.qk(a, "panes_changed", e),
        _.qk(f, "zoom_changed", e),
        _.qk(f, "offset_changed", e),
        _.qk(b, "projection_changed", e),
        _.qk(f, "projectioncenterq_changed", e),
      ];
      _.Xm(d.Fh);
      b instanceof _.Nk
        ? (_.xl(b, "Ox"), _.vl(b, 148440))
        : b instanceof _.Tl && (_.xl(b, "Oxs"), _.vl(b, 181451));
    },
    Jma = function (a) {
      if (a) {
        var b = a.getMap();
        if (Fma(a) !== b && b && b instanceof _.Nk) {
          const c = b.__gm;
          c.overlayLayer
  ...
  QD.Uk = function (a) {
    if (a) {
      var b = a.getMap();
      (PD(a).nB || null) !== b && (b && Ema(a, b), (PD(a).nB = b));
    }
  };
  QD.sl = function (a) {
    const b = PD(a);
  ...
  var RD = {},
    ...
    Hma = class {
      ...
      dispose() {}
      Ri(a, b, c, d, e, f, g, h) {
        const l = (this.Fg = this.Fg || new _.GB(this.Jg, this.Hg, () => {}));
        l.Ri(a, b, c, d, e, f, g, h);
        for (const n of this.Gg) Kma(n, l), n.draw();
      }
      Uk(a) {
        this.Gg.push(a);
        this.Fg && Kma(a, this.Fg);
        this.Hg.refresh();
      }
      sl(a) {
        _.Wb(this.Gg, a);
  ...
  _.ik("overlay", {
    Fz: function (a) {
      if (a) {
        ...
        (0, RD.sl)(a);
        var b = a.getMap();
        b && (b instanceof _.Nk ? (0, RD.Uk)(a) : (0, QD.Uk)(a));
      }
    },
    ...
    preventMapHitsAndGesturesFrom: (a) => {
      ...
      a.addEventListener("MSPointerDown", _.ok);
