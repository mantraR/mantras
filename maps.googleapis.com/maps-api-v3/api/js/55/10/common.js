google.maps.__gjsload__("common", function (_) {
  ...
  Tda = function (a, b, c) {
    const d = b.Tw(),
      e = b.getMetadata();
    var f = a.Lg && !1;
    f = a.Gg || f ? new _.hg(new _.Fg({ AI: a.Gg, VH: f })) : new _.hg();
    c += d.Oj();
    ...
    a = c;
    h = new _.Np({ lj: f, hG: void 0 }, d.Gg);
  ...
  _.fu = function (a, b, c, d = 0) {
    ...
    if (e && null != f && g) {
      ...
      d = b.Ow({ center: a, zoom: f, tilt: h, heading: l }, e);
      c = au(_.Vt(g), c);
  ...
  Uv = function (a, b) {
    const c = Sv(a.Fg.Zk());
    var d = b.Jh.shiftKey;
    d = (a.Hg && 1 === c.em && a.Fg.Oi.BE) || (d && a.Fg.Oi.MH) || a.Fg.Oi.np;
      ...
      if (!c && !d && Date.now() < a.Ng + 250)
        ...
        if (a.isActive && (d || 3 !== a.Jg.Mk))
          for (const h of kw(b)) {
            ...
            g = a.lh.Aj.wrap(g);
            f = _.pw(f, g, l);
            const n = a.Jg.RF({ ah: a.Gg, di: h, DI: f });
            a.Fg.set(e, n);
  ...
  gfa = [_.N, _.P];
  tfa = { eJ: 0, cJ: 1, aJ: 2, bJ: 3, YI: 5, ZI: 6 };
  rfa = [_.mq];
  _.Qt = !1;
  Rt = !1;
  Tfa = class {
  ...
  var nea = class {
    ...
    Tga = class {
      ...
      ml() {}
      Ep() {
        if (this.Fg.Oi.zG && 3 !== this.Jg && this.Fg.Oi.zG(this.Gg))
    ...
    Uga = class {
      ...
      ak(a) {
        ...
        !b && this.Fg.Oi.Lx && this.Fg.Oi.Lx(this.Hg, this.Gg);
        return Lv(a) ? new Tv(this.Fg) : new Tga(this.Fg, b, a.button);
      }
      Nk() {}
      nk() {}
      Ep() {
        this.Fg.Oi.Lx && this.Fg.Oi.Lx(this.Hg, this.Gg);
  ...
  _.OB = class {
    ...
    Ri(a, b, c, d, e, f, g, h) {
      ...
      n = (1 === this.Jg.Mk && e && this.lh.Ow(e)) || a;
      l = this.Jg.li;
